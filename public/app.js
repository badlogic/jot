  ...
  function openAgentModal(refs) {
    ...
    if (isOwnerView) {
      lines.push(
        ...
        ``,
        `# List notes`,
        `npx @mariozechner/jot my-jot list`,
        ``,
        `# Read this note (includes thread/message IDs)`,
        `npx @mariozechner/jot my-jot read ${currentNoteId}`,
        ``,
        `# Create a note`,
        `npx @mariozechner/jot my-jot create "My note title"`,
        ``,
        `# Edit this note`,
        `npx @mariozechner/jot my-jot edit ${currentNoteId} '[{"oldText":"...","newText":"..."}]'`,
        ``,
        `# Comment on text in this note`,
        `npx @mariozechner/jot my-jot comment ${currentNoteId} "quoted text" "comment body"`,
        ``,
        `# Reply to a specific message`,
        `npx @mariozechner/jot my-jot reply ${currentNoteId} <thread-id> <message-id> "reply"`,
        ``,
        `# Edit or delete a comment`,
        `npx @mariozechner/jot my-jot edit-comment ${currentNoteId} <message-id> "new body"`,
        `npx @mariozechner/jot my-jot delete-comment ${currentNoteId} <message-id>`,
        ``,
        `# Resolve, reopen, or delete a thread`,
        `npx @mariozechner/jot my-jot resolve ${currentNoteId} <thread-id>`,
        `npx @mariozechner/jot my-jot reopen ${currentNoteId} <thread-id>`,
        `npx @mariozechner/jot my-jot delete-thread ${currentNoteId} <thread-id>`,
        ``,
        `# Full command reference`,
        `npx @mariozechner/jot --help`,
      );
    } else {
      ...
      lines.push(
        ...
        `npx @mariozechner/jot my-jot read`,
        ``,
        `# Edit the note (if edit access)`,
        `npx @mariozechner/jot my-jot edit '[{"oldText":"...","newText":"..."}]'`,
        ``,
        `# Comment on text`,
        `npx @mariozechner/jot my-jot comment "quoted text" "comment body" --name="My Agent"`,
        ``,
        `# Reply to a specific message`,
        `npx @mariozechner/jot my-jot reply <thread-id> <message-id> "reply" --name="My Agent"`,
        ``,
        `# Full command reference`,
        `npx @mariozechner/jot --help`,
      );
